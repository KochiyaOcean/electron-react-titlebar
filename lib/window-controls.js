  ...
  render() {
    ...
    return _react2.default.createElement(
      ...
      _react2.default.createElement(
        'button',
        { 'aria-label': 'minimize', title: 'Minimize', tabIndex: '-1', className: 'window-control minimize', disabled: disableMinimize,
      ...
      _react2.default.createElement(
        'button',
        { 'aria-label': 'maximize', title: 'Maximize', tabIndex: '-1', className: 'window-control maximize', disabled: disableMaximize,
      ...
      _react2.default.createElement(
        'button',
        { 'aria-label': 'close', title: 'Close', tabIndex: '-1', className: 'window-control close',
