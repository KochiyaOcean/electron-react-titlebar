  ...
  render() {
    ...
    return (
      <div className="window-controls">
        <button aria-label="minimize" title="Minimize" tabIndex="-1" className="window-control minimize" disabled={disableMinimize}
          onClick={e => currentWindow.minimize()}>
          <svg aria-hidden="true" version="1.1" width="10" height="10">
            <path d="M 0,5 10,5 10,6 0,6 Z" />
          </svg>
        </button>
        <button aria-label="maximize" title="Maximize" tabIndex="-1" className="window-control maximize" disabled={disableMaximize}
        ...
        <button aria-label="close" title="Close" tabIndex="-1" className="window-control close"
